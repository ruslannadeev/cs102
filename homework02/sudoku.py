...
def get_block(grid: List[List[str]], pos: Tuple[int, int]) -> List[str]:
    ...
    ['2', '8', '.', '.', '.', '5', '.', '7', '9']
    """
    blockIndex = (pos[0] // 3, pos[1] // 3)
    res = []
    for i in range(blockIndex[0] * 3, blockIndex[0] * 3 + 3):
        for j in range(blockIndex[1] * 3, blockIndex[1] * 3 + 3):
            res.append(grid[i][j])
    return res
...
def copy(grid: List[List[str]]) -> List[List[str]]:
    res = []
